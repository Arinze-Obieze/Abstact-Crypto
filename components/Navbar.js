    ...
    return (
        <div>
            ...
            <header className="flex shadow-md justify-between mr-1">
                ...
                <Link href={'/'} className='space-x-4'><h1 className="mt-5 text-blue-500 font-serif font-semibold text-lg"> <span className="text-red-500">ABSTRACT</span>    CRYPTO</h1></Link>
                <nav className="flex mt-5 space-x-4">
                    ...
                    <Link className="hover:text-red-500 hover:underline" href={'#'} >Chart</Link>
